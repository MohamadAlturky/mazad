...
public class ToggleCategoryAttributeCommandValidator : BaseCommandValidator<ToggleCategoryAttributeCommand>
{
    public override Result Validate(ToggleCategoryAttributeCommand command)
    {
