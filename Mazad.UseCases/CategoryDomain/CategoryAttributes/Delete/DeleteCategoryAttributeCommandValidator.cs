...
public class DeleteCategoryAttributeCommandValidator : BaseCommandValidator<DeleteCategoryAttributeCommand>
{
    public override Result Validate(DeleteCategoryAttributeCommand command)
    {
